...
export default function Workouts() {
  ...
  return (
    <div className="screen">
      ...
      <div style={{display: "flex", flexDirection:"row", position: "relative", gap: "10px"}}>      <p style={{textAlign: "center"}}>Week {currentWeek}</p>
      ...
      <div className="plans-card">
        ...
        <div className="card" key = {workout.WorkoutID}  onClick={() => navigate("/newworkout",{ state: {workout: workout, currentWeek: currentWeek} })}>
        ...
        <img src="../images/plus2.png" alt="Add Plan" className="plus-icon" onClick={() => navigate("/newworkout",{ state: { currentWeek: currentWeek, maxWeeks: maxWeeks, new: true, planID: selectedPlan?.planID } })}/>
